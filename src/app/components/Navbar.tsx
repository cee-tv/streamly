...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-5 left-1/4 transform -translate-x-1/2 bg-white/10 backdrop-blur-lg text-white py-2 px-6 rounded-full z-50 shadow-md flex items-center justify-between space-x-8 w-auto">
      {/* Logo */}
