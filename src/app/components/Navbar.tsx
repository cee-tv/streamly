...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-full transform -translate-x-1/2 bg-white/10 backdrop-blur-lg text-white py-2 px-6 rounded-full z-50 shadow-md flex items-center justify-between space-x-8 w-full">
      {/* Logo */}
